...
(
    ...
    IATACode NVARCHAR(10) NOT NULL,               -- 3-letter IATA airport code (e.g., SGN, HAN)
    [Airport Name] NVARCHAR(255) NULL,            -- Full airport name
    City NVARCHAR(100) NULL,                      -- City where airport is located
    Country NVARCHAR(100) NULL,                   -- Country where airport is located
...
(
    [index] BIGINT IDENTITY(1,1) PRIMARY KEY,
    Sector NVARCHAR(20) NOT NULL,                 -- Route sector code (e.g., SGNHAN)
    [Distance mile GDS] BIGINT NULL,              -- Distance in miles from GDS
    [Distance km GDS] FLOAT NULL,                 -- Distance in kilometers from GDS
    Sector_2 NVARCHAR(20) NULL,                   -- Alternative sector format
    Route NVARCHAR(100) NULL,                     -- Route description
    [Country 1] NVARCHAR(100) NULL,               -- Origin country
    [Country 2] NVARCHAR(100) NULL,               -- Destination country
    Country NVARCHAR(100) NULL,                   -- Primary country for route classification
    [DOM/INT] NVARCHAR(10) NULL,                  -- Domestic (DOM) or International (INT)
    Area NVARCHAR(100) NULL,                      -- Geographic area/region
...
(
    ...
    Region NVARCHAR(100) NOT NULL,                -- Geographic region
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL,
    updated_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    [index] BIGINT IDENTITY(1,1) PRIMARY KEY,
    CARRIER NVARCHAR(10) NOT NULL,                -- 2-letter airline code (e.g., VN, VJ)
    QG NVARCHAR(10) NULL,                         -- Country code for airline
    [Airlines name] NVARCHAR(255) NULL,           -- Full airline name
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL,
    updated_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    [index] BIGINT IDENTITY(1,1) PRIMARY KEY,
    [ROUTE] NVARCHAR(20) NOT NULL,                -- Route code
    [AC] NVARCHAR(20) NULL,                       -- Aircraft type for route
    [Route_ID] NVARCHAR(50) NULL,                 -- Unique route identifier
    [FH (THEO GIỜ)] TIME(7) NULL,                 -- Flight hours (time format)
    [FLIGHT HOUR] FLOAT NULL,                     -- Flight hours (decimal)
    [TAXI] FLOAT NULL,                            -- Taxi time in hours
    [BLOCK HOUR] FLOAT NULL,                      -- Total block time
    [DISTANCE KM] FLOAT NULL,                     -- Distance in kilometers
    [Loại] NVARCHAR(50) NULL,                     -- Route type in Vietnamese
    [Type] NVARCHAR(50) NULL,                     -- Route type in English
    [Country] NVARCHAR(100) NULL,                 -- Country classification
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL,
    updated_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    [index] BIGINT IDENTITY(1,1) PRIMARY KEY,
    actype NVARCHAR(50) NOT NULL UNIQUE,          -- Aircraft type code (e.g., A320, B777)
    seat BIGINT NOT NULL,                         -- Standard seat capacity
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL,
    updated_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    ...
    ACRegNo NVARCHAR(20) NOT NULL,                -- Aircraft registration number
    Brand NVARCHAR(50) NULL,                      -- Aircraft manufacturer
    AC_Type NVARCHAR(50) NULL,                    -- Aircraft type
    Seat BIGINT NULL,                             -- Actual seat count for this aircraft
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL,
    updated_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    id BIGINT IDENTITY(1,1) PRIMARY KEY,
    flightdate NVARCHAR(255) NULL,                -- Flight date (various formats from Excel)
    flightno NVARCHAR(50) NULL,                   -- Flight number
    route NVARCHAR(100) NULL,                     -- Route (e.g., SGN-HAN)
    actype NVARCHAR(50) NULL,                     -- Aircraft type
    seat BIGINT NULL,                             -- Seat capacity
    adl FLOAT NULL,                               -- Adult passengers
    chd FLOAT NULL,                               -- Child passengers
    cgo FLOAT NULL,                               -- Cargo weight
    mail FLOAT NULL,                              -- Mail weight
    totalpax FLOAT NULL,                          -- Total passengers (calculated)
    source NVARCHAR(500) NULL,                    -- Source file name
...
(
    id BIGINT IDENTITY(1,1) PRIMARY KEY,
    convert_date BIGINT NULL,                     -- Flight date in YYYYMMDD format
    flightno NVARCHAR(50) NULL,                   -- Flight number
    route NVARCHAR(100) NULL,                     -- Route
    actype NVARCHAR(50) NULL,                     -- Aircraft type
    totalpax FLOAT NULL,                          -- Total passengers
    cgo FLOAT NULL,                               -- Cargo weight
    mail FLOAT NULL,                              -- Mail weight
    acregno NVARCHAR(50) NULL,                    -- Aircraft registration
    source NVARCHAR(500) NULL,                    -- Source file
    sheet_name NVARCHAR(255) NULL,                -- Source sheet
    region_type INT NOT NULL DEFAULT 0,           -- Region classification
    seat BIGINT NULL,                             -- Seat capacity
    week_number INT NULL,                         -- Week number
    year_number INT NULL,                         -- Year
    note NVARCHAR(255) NULL,                      -- Notes
    type_filter INT NULL,                         -- Flight type filter
    inserted_time DATETIME DEFAULT GETDATE() NOT NULL,
    int_dom_ NVARCHAR(10) NULL,                   -- Domestic/International
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL,
    updated_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    id BIGINT IDENTITY(1,1) PRIMARY KEY,
    [FLIGHT_DATE] NVARCHAR(50) NULL,              -- Original flight date
    [FLIGHT_DATE_FORMAT] DATE NULL,               -- Standardized flight date
    [FLIGHT_NO] NVARCHAR(50) NULL,                -- Flight number
    [ACTYPE] NVARCHAR(50) NULL,                   -- Aircraft type
    [SECTOR] NVARCHAR(20) NULL,                   -- Route sector
    [TOTAL_PAX] FLOAT NULL,                       -- Total passengers
    [CGO] FLOAT NULL,                             -- Cargo
    [MAIL] FLOAT NULL,                            -- Mail
    [SEAT] BIGINT NULL,                           -- Seat capacity
    [DEPARTURE] NVARCHAR(10) NULL,                -- Departure airport code
    [ARRIVES] NVARCHAR(10) NULL,                  -- Arrival airport code
    [AIRLINES NAME] NVARCHAR(255) NULL,           -- Airline name
    [COUNTRY] NVARCHAR(100) NULL,                 -- Route country
    [DOM/INT] NVARCHAR(10) NULL,                  -- Domestic/International
    [COM] NVARCHAR(1) NOT NULL DEFAULT '',       -- Commercial flag
    [REGION] NVARCHAR(100) NULL,                  -- Geographic region
    [CITY_ARRIVES] NVARCHAR(100) NULL,            -- Arrival city
    [COUNTRY_ARRIVES] NVARCHAR(100) NULL,         -- Arrival country
    [CITY_DEPARTURE] NVARCHAR(100) NULL,          -- Departure city
    [COUNTRY_DEPARTURE] NVARCHAR(100) NULL,       -- Departure country
    [source] NVARCHAR(500) NULL,                  -- Data source
    [rnk_sg] INT NOT NULL DEFAULT 0,              -- Ranking
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL,
    updated_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    id BIGINT IDENTITY(1,1) PRIMARY KEY,
    flight_date_format DATE NULL,                 -- First flight date
    source NVARCHAR(500) NULL,                    -- Source airport
    sortedroute NVARCHAR(20) NULL,                -- Standardized route
    flight_no NVARCHAR(50) NULL,                  -- Flight number
    flight_date_format_ DATE NULL,                -- Second flight date
    source_ NVARCHAR(500) NULL,                   -- Destination airport
    sortedroute_ NVARCHAR(20) NULL,               -- Return route
    flight_no_ NVARCHAR(50) NULL,                 -- Return flight number
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    id BIGINT IDENTITY(1,1) PRIMARY KEY,
    flightdate NVARCHAR(255) NULL,                -- Original flight date
    flightno NVARCHAR(50) NULL,                   -- Flight number
    route NVARCHAR(100) NULL,                     -- Route
    actype NVARCHAR(50) NULL,                     -- Aircraft type
    seat BIGINT NULL,                             -- Seat capacity
    ...
    source NVARCHAR(500) NULL,                    -- Source file
    acregno NVARCHAR(50) NULL,                    -- Aircraft registration
    sheet_name NVARCHAR(255) NULL,                -- Sheet name
    totalpax FLOAT NULL,                          -- Total passengers
    int_dom NVARCHAR(10) NULL,                    -- Domestic/International
    Is_InvalidFlightDate INT NULL,                -- Date validation flag
    Is_InvalidPassengerCargo INT NULL,            -- Passenger/cargo validation flag
    Is_InvalidRoute INT NULL,                     -- Route validation flag
    Is_InvalidActypeSeat INT NULL,                -- Aircraft type validation flag
...
(
    id BIGINT IDENTITY(1,1) PRIMARY KEY,
    flightdate NVARCHAR(255) NULL,                -- Flight date
    flightno NVARCHAR(50) NULL,                   -- Flight number
    route NVARCHAR(100) NULL,                     -- Route
    actype NVARCHAR(50) NULL,                     -- Aircraft type
    seat BIGINT NULL,                             -- Seat capacity
    ...
    ErrorReason NVARCHAR(MAX) NULL,               -- Error description
    TotalErrors INT NULL,                         -- Error count
    inserted_time DATETIME DEFAULT GETDATE() NOT NULL,
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    ...
    file_name NVARCHAR(255) NOT NULL,             -- Name of imported file
    import_date DATETIME DEFAULT GETDATE() NOT NULL, -- Import timestamp
    source_type NVARCHAR(50) NULL,                -- Type of source (MN, MB, MT, etc.)
    status NVARCHAR(20) DEFAULT 'imported' NOT NULL, -- Import status
    row_count INT NULL,                           -- Number of rows imported
    clean_data INT NULL,                          -- Flag for cleaned data
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    ...
    [Type] NVARCHAR(50) NULL,                     -- Type of missing data (ACTYPE/ROUTE)
    [Value] NVARCHAR(255) NULL,                   -- Missing value
    SourceSheet NVARCHAR(255) NULL,               -- Source sheet where missing data found
    CreatedAt DATETIME NULL DEFAULT GETDATE(),   -- When missing data was logged
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
...
(
    Actype NVARCHAR(255) NOT NULL PRIMARY KEY,   -- Aircraft type code
    Seat INT NULL,                                -- Seat capacity
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
GO
...
(
    Route NVARCHAR(255) NOT NULL PRIMARY KEY,    -- Route code
    AC NVARCHAR(50) NULL,                         -- Aircraft type
    Route_ID NVARCHAR(50) NULL,                   -- Route identifier
    [FH (THEO GIỜ)] DECIMAL(10, 2) NULL,         -- Flight hours
    [FLIGHT HOUR] DECIMAL(10, 2) NULL,           -- Flight duration
    TAXI DECIMAL(10, 2) NULL,                     -- Taxi time
    [BLOCK HOUR] DECIMAL(10, 2) NULL,            -- Block time
    [DISTANCE KM] INT NULL,                       -- Distance in kilometers
    [Loại] NVARCHAR(50) NULL,                     -- Route type (Vietnamese)
    [Type] NVARCHAR(50) NULL,                     -- Route type (English)
    Country NVARCHAR(100) NULL,                   -- Country classification
    created_at DATETIME2 DEFAULT SYSDATETIME() NOT NULL
);
GO
...
CREATE VIEW source_pbi_final AS 
WITH flight_data AS (
    SELECT *, 
        CASE 
...
SELECT 
    ...
    AI1.COUNTRY AS COUNTRY_DEPARTURE              -- Departure country
FROM 
    flight_data F
LEFT JOIN 
    AIRLINE_DETAILS A1 
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            flightdate, flightno, route, actype, seat, adl, chd, cgo, mail,
            source, acregno, sheet_name, totalpax, int_dom,
            0, 0, 0, 0, NULL, 0 -- Initialize error flags and counts
        FROM flight_raw
        WHERE source IN (SELECT file_name FROM import_log WHERE file_name NOT IN (
            SELECT DISTINCT source FROM flight_clean_data_stg 
            UNION 
            SELECT DISTINCT source FROM flight_data_chot
        ));
        ...
        SET
            ...
            Is_InvalidRoute = CAST(CASE 
                WHEN NOT EXISTS (
                    SELECT 1 FROM Airline_Route_Details ARD
                    WHERE ARD.SECTOR = (
                        CASE
    ...
    BEGIN TRY
        ...
        WHERE clean_data IS NULL
          AND file_name IN (
              SELECT DISTINCT source FROM flight_data_chot
              UNION
              SELECT DISTINCT source FROM error_table
          );
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO actype_seat (actype, seat)
        SELECT
            tai.Actype,
            tai.Seat
...
BEGIN
    ...
    -- Log missing routes
    INSERT INTO Missing_Dimensions_Log (Type, Value, SourceSheet)
    SELECT DISTINCT
        'ROUTE',
        et.route,
        et.sheet_name
...
-- Sample aircraft type and seat data
INSERT INTO TempActypeImport (actype)
VALUES
    ('THD'),
    ('HPH'), 
    ('HAN'),
