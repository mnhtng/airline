...
class DimSectorRouteDomRef(Base):
    """
    ...
    def __repr__(self):
        """Represent the DimSectorRouteDomRef model as a string"""
        return f"<DimSectorRouteDomRef(sector='{self.sector}', area_lv1='{self.area_lv1}', dom_int='{self.dom_int}')>"
